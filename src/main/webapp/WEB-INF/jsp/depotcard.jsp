...
function addDepotCard() {
	$.ajax({
		type:'get',
		url:'/index/card/findAllCardType',
		datatype:'json',
		data:'',
...
function alertCard(status) {
	...
	$.ajax({
		type:'get',
		url:'/index/card/findDepotCardByCardnum',
		datatype:'json',
...
function deleteDepotCardSubmit(status){
	...
	$.ajax({
		type:'post',
		url:'/index/card/deleteDepotCard',
		datatype:'text',
		data:{"cardnum":cardnum},
		contentType:'application/x-www-form-urlencoded',
		success:function(data){
...
function rechargeDepotCardSubmit()
{
	...
	$.ajax({
		type:'post',
		url:'/index/card/rechargeDepotCardSubmit',
		datatype:'json',
		data:$("#checkForm").serializeArray(),
		success:function(data){
			if(data.code==100)
