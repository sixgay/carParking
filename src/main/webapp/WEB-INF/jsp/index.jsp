...
<body>
	<div class="topscan">
		<div class="top-left"><span class="glyphicon glyphicon-home"></span><b> 停车场管理系统</b></div>
...
$(document).ready(function(){
	...
	function fileUpload(parkId)
	 {
		/*  window.location.assign("http://localhost:8080/index/incomeCharts") */
		$("#id").val(parkId);
	 }
	...
	function checkOut(parknum) {
		 $.ajax({
			type:'get',
			url:'/index/check/findParkinfoByParknum',
			datatype:'json',
...
/* 				+ "<label>是否临时停车：</label><br>"
	...
	function checkOutByCardnum() {
		...
		if(cardnum=="")
		 ...
		 $.ajax({
			type:'get',
			url:'/index/check/findParkinfoByCardnum',
			datatype:'json',
	...
	function checkDetail(parknum) {
		 $.ajax({
			type:'get',
			url:'/index/check/findParkinfoDetailByParknum',
			datatype:'json',
			data:{parkNum:parknum},
			success:function(data){
				var username="";
...
/* 				+ "<label>是否临时停车：</label><br>"
	...
	/*查看停车情况*/
		function nowCar(){
 			window.location.assign("http://localhost:8080/index/line")
 			}
